...
int dados[MAX];
int inicio     = 0;   /* índice de onde sai */
int fim   = 0;   /* índice de onde entra */
int tamanho  = 0;
...
void enqueue(int valor) {
    ...
    dados[fim] = valor;
    fim = (fim + 1) % MAX;   /* avança em círculo */
    tamanho++;
}
...
int dequeue() {
    ...
    inicio = (inicio + 1) % MAX;   /* avança em círculo */
    tamanho--;
    return valor;
}
